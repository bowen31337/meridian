"""
Shared test fixtures for the repository conformance suite.
...
import pytest
from storage_repository._audit import AuditLog
from storage_repository._types import AuditLogEntry
...
def mock_tracer(monkeypatch: pytest.MonkeyPatch) -> MockTracer:
    tracer = MockTracer()
    monkeypatch.setattr("storage_repository._runtime.get_tracer", lambda: tracer)
    return tracer
