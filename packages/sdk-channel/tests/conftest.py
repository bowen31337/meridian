"""
Shared test fixtures for the channel conformance suite.
...
import pytest
from sdk_channel._audit import AuditLog
...
def mock_tracer(monkeypatch: pytest.MonkeyPatch) -> MockTracer:
    tracer = MockTracer()
    monkeypatch.setattr("sdk_channel._runtime.get_tracer", lambda: tracer)
    return tracer
