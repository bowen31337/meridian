...
class TestHandoffNoSchema:
    def test_returns_200_without_output_schema(self, storage_root: Path) -> None:
        ...
        resp = client.post(
            "/v1/x/sessions/no-schema-1/handoff", json={"terminal_message": "anything"}
        )
    ...
    def test_response_status_completed(self, storage_root: Path) -> None:
        ...
        client = _make_client(storage_root)
        body = client.post(
            "/v1/x/sessions/no-schema-2/handoff", json={"terminal_message": None}
        ).json()
    ...
    def test_response_validation_passed(self, storage_root: Path) -> None:
        ...
        client = _make_client(storage_root)
        body = client.post(
            "/v1/x/sessions/no-schema-3/handoff", json={"terminal_message": {}}
        ).json()
    ...
    def test_response_has_session_id(self, storage_root: Path) -> None:
        ...
        client = _make_client(storage_root)
        body = client.post(
            "/v1/x/sessions/no-schema-5/handoff", json={"terminal_message": 1}
        ).json()
    ...
    def test_response_has_parent_session_id(self, storage_root: Path) -> None:
        ...
        client = _make_client(storage_root)
        body = client.post(
            "/v1/x/sessions/no-schema-6/handoff", json={"terminal_message": 1}
        ).json()
...
class TestHandoffSchemaPass:
    ...
    def test_response_validation_passed_on_schema_match(self, storage_root: Path) -> None:
        ...
        client = _make_client(storage_root)
        body = client.post(
            "/v1/x/sessions/pass-3/handoff", json={"terminal_message": _VALID_MSG}
        ).json()
        assert body["validation"] == "passed"
...
class TestHandoffFirstFailure:
    ...
    def test_error_code_handoff_schema_invalid(self, storage_root: Path) -> None:
        ...
        client = _make_client(storage_root)
        body = client.post(
            "/v1/x/sessions/fail-2/handoff", json={"terminal_message": _INVALID_MSG}
        ).json()
    ...
    def test_retry_allowed_true_on_first_failure(self, storage_root: Path) -> None:
        ...
        client = _make_client(storage_root)
        body = client.post(
            "/v1/x/sessions/fail-3/handoff", json={"terminal_message": _INVALID_MSG}
        ).json()
    ...
    def test_validation_errors_present_on_failure(self, storage_root: Path) -> None:
        ...
        client = _make_client(storage_root)
        body = client.post(
            "/v1/x/sessions/fail-4/handoff", json={"terminal_message": _INVALID_MSG}
        ).json()
    ...
    def test_error_message_mentions_session_id(self, storage_root: Path) -> None:
        ...
        client = _make_client(storage_root)
        body = client.post(
            "/v1/x/sessions/fail-6/handoff", json={"terminal_message": _INVALID_MSG}
        ).json()
...
class TestHandoffRetryExhausted:
    def test_returns_422_on_second_failure(self, storage_root: Path) -> None:
        ...
        client = _make_client(storage_root)
        resp = client.post(
            "/v1/x/sessions/retry-1/handoff", json={"terminal_message": _INVALID_MSG}
        )
        assert resp.status_code == 422
    ...
    def test_retry_allowed_false_on_second_failure(self, storage_root: Path) -> None:
        ...
        client = _make_client(storage_root)
        body = client.post(
            "/v1/x/sessions/retry-2/handoff", json={"terminal_message": _INVALID_MSG}
        ).json()
        assert body["error"]["retry_allowed"] is False

    def test_manifest_stays_waiting_for_user_after_exhausted_retry(
...
class TestHandoffAuditLog:
    ...
    def test_schema_failure_audit_level_error(self, storage_root: Path) -> None:
        ...
        record = next(
            r for r in _audit_records(storage_root) if r.get("event") == "handoff.schema_invalid"
        )
    ...
    def test_schema_failure_audit_detail_retry_allowed_false_on_retry(
        self, storage_root: Path
    ) -> None:
